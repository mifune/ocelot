...
pkgdatadir = $(datadir)/ocelot
pkgincludedir = $(includedir)/ocelot
pkglibdir = $(libdir)/ocelot
pkglibexecdir = $(libexecdir)/ocelot
...
am_ocelot_OBJECTS = db.$(OBJEXT) logger.$(OBJEXT) events.$(OBJEXT) \
...
ACLOCAL = ${SHELL} /home/paranormal/ocelot/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AUTOCONF = ${SHELL} /home/paranormal/ocelot/missing --run autoconf
AUTOHEADER = ${SHELL} /home/paranormal/ocelot/missing --run autoheader
AUTOMAKE = ${SHELL} /home/paranormal/ocelot/missing --run automake-1.11
AWK = mawk
...
CXXFLAGS = -g -O2
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"ocelot\" -DPACKAGE_TARNAME=\"ocelot\" -DPACKAGE_VERSION=\"0.8\" -DPACKAGE_STRING=\"ocelot\ 0.8\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DHAVE_BOOST=/\*\*/ -DHAVE_BOOST_IOSTREAMS=/\*\*/ -DHAVE_BOOST_SYSTEM=/\*\*/ -DHAVE_BOOST_THREAD=/\*\*/ -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE_ARPA_INET_H=1 -DHAVE_FCNTL_H=1 -DHAVE_NETINET_IN_H=1 -DHAVE_SYS_SOCKET_H=1 -DHAVE_UNISTD_H=1 -DHAVE__BOOL=1 -DHAVE_MEMSET=1 -DHAVE_SOCKET=1 -DHAVE_STRERROR=1
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
EGREP = /bin/grep -E
EV_INC_DIR = /usr/include
EV_LIB_DIR = /usr/lib
EXEEXT = 
GREP = /bin/grep
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/paranormal/ocelot/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
MYSQLPP_INC_DIR = /usr/include/mysql++
MYSQLPP_LIB_DIR = /usr/lib
MYSQL_C_INC_DIR = /usr/include/mysql
MYSQL_C_LIB_DIR = /usr/lib/x86_64-linux-gnu
...
STRIP = 
VERSION = 0.8
abs_builddir = /home/paranormal/ocelot
abs_srcdir = /home/paranormal/ocelot
abs_top_builddir = /home/paranormal/ocelot
abs_top_srcdir = /home/paranormal/ocelot
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/paranormal/ocelot/install-sh
...
ocelot_SOURCES = config.h db.cpp db.h logger.cpp logger.h events.cpp events.h \
...
ocelot_LDFLAGS = $(BOOST_IOSTREAMS_LIB) $(BOOST_SYSTEM_LIB) $(BOOST_THREAD_LIB) -L$(MYSQLPP_LIB_DIR) -pthread
...
ocelot$(EXEEXT): $(ocelot_OBJECTS) $(ocelot_DEPENDENCIES) $(EXTRA_ocelot_DEPENDENCIES) 
	@rm -f ocelot$(EXEEXT)
	$(ocelot_LINK) $(ocelot_OBJECTS) $(ocelot_LDADD) $(LIBS)
...
include ./$(DEPDIR)/misc_functions.Po
include ./$(DEPDIR)/ocelot.Po
include ./$(DEPDIR)/schedule.Po
include ./$(DEPDIR)/site_comm.Po
